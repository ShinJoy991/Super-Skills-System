...
import com.github.shinjoy991.superskillssystem.gui.screen.SkillWheelScreen;
...
public class InputEvents {
    ...
    public static void onKeyInput(InputEvent.Key event) {
        ...
        else if (ClientKeyMapping.SKILL_WHEEL_KEY.consumeClick()) {
            Minecraft minecraft = Minecraft.getInstance();
            if (minecraft.player != null) {
                Minecraft.getInstance().setScreen(
                        new SkillWheelScreen()
                );
            }
        }
    }
    ...
    public static class ClientModEvents {
        ...
        public static void clientSetup(RegisterKeyMappingsEvent event) {
            ...
            event.register(ClientKeyMapping.SKILL_WHEEL_KEY);
        }
    }
}